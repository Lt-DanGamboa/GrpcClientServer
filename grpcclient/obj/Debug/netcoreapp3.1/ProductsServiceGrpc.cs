...
namespace curso {
  public static partial class ProductsService
  {
    ...
    static readonly grpc::Marshaller<global::curso.ProductRequest> __Marshaller_ProductRequest = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::curso.ProductRequest.Parser));
    static readonly grpc::Marshaller<global::curso.Product> __Marshaller_Product = grpc::Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, global::curso.Product.Parser));
